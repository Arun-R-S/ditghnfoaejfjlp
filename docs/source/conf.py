...
project = u'Sonix'
copyright = u'2025, Sonix'
author = u'Arun R S, EchoWaveSystems & Friends'
...
latex_documents = [
    (master_doc, 'ESPEasy.tex', u'Sonix Documentation',
     u'Many', 'manual'),
]
...
man_pages = [
    (master_doc, 'espeasy', u'Sonix Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sonix', u'Sonix Documentation',
     author, 'Sonix', 'ESP82xx/ESP32 firmware to connect people with any level of experience to system automation.',
     'Miscellaneous'),
]
...
# This def is used to add Sonix related formatation (color etc).
def setup(app):
    app.add_css_file('css/custom.css')

# To replace chunks of text globally +
# Sonix colors (set in cutom.css)
rst_prolog = """
.. role:: blue
.. role:: red
.. role:: green
...
.. |unit_url| replace:: http://<sonix ip or host name>/

...
# define GITHUB_RELEASES_LINK_PREFIX "<a href='https://github.com/Arun-R-S' title='Click to show latest release on Github' target='_blank' style='font-size: 15px; text-decoration: none'>"
#endif

...
#define WEBPAGE_TEMPLATE_DEFAULT_FOOTER "<footer><br><h6>Powered by <a href='https://sonix.arunrs.com' style='font-size: 15px; text-decoration: none'>Sonix</a></h6></footer></body></html>"
